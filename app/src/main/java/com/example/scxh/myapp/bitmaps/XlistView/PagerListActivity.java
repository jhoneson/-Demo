...
public class PagerListActivity extends AppCompatActivity implements AbsListView.OnScrollListener {
    ...
    private ConnectionUtil mConnectionUtils;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mConnectionUtils = new ConnectionUtil(this);
    ...
    public void getDataLists(int current) {
        ...
        mConnectionUtils.asycnConnect(baseUrl, paramsMap, ConnectionUtil.Method.GET, new ConnectionUtil.HttpConnectionInterface() {
            @Override
    ...
    public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
        Log.e("","firstVisibleItem :" + firstVisibleItem + " ,visibleItemCount :" + visibleItemCount + " ,totalItemCount :" + totalItemCount);
