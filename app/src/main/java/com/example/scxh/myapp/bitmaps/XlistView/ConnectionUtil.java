package com.example.scxh.myapp.bitmaps.XlistView;
...
public class ConnectionUtil {
    ...
    private static boolean isCache = true; //是否添加缓存

    public enum Method {  //// TODO: 2016/7/28 enum 枚举
        GET, POST
    }
    ...
    public void asycnConnect(final String httpUrl, final HashMap<String, String> paramtMap, final Method method, final Cache isCache, final HttpConnectionInterface httpConnectionInterface) {
        new AsyncTask<String, Void, String>() {
            ...
            protected void onPostExecute(String content) {
                httpConnectionInterface.execute(content);  //回调
            }
        }.execute(httpUrl);
    }
    ...
    public String doHttpConnection(String httpUrl, HashMap<String, String> paramtMap, Method method, Cache isCache) {
        if (method == Method.GET) {
            if (paramtMap != null) {
                ...
                httpUrl = httpUrl + paramUrl; // 拼接 requestUrl = http://192.168.5.11:8080/webapp/login?userName=admin1&passWord=1234566
            }
    ...
    public String doGetPostHttp(String httpUrl, HashMap<String, String> paramtMap, Method method, Cache isCache) {
        ...
        try {
            ...
            urlConnection.setReadTimeout(10000);    //读数据超时
            ...
            }//// TODO: 2016/7/28 用 SharedPreferences保存缓存数据
